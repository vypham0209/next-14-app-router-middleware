...
type TMealListProps = {
  data: RouterOutputs['mealPlan']['trackingMealPlan']['dishInMealPlanOrder'][string][DayOfWeek];
};
...
function MealList({ data }: TMealListProps) {
  ...
  return (
    <div className={classcat(['grid grid-cols-1 gap-6 pt-4', 'md:pt-0 lg:grid-cols-3'])}>
      {dataSorted?.map((item) => (
