        ...
        <div className={classcat(['grid grid-cols-1 gap-4'])}>
          <div className={classcat(['grid grid-cols-1 gap-1', 'md:gap-2'])}>
            <div className={classcat(['grid grid-cols-1 gap-4'])}>
              ...
              {/* TODO show when have promotion feature*/}
              {/* <div className={classcat(['flex justify-between'])}>
                <p className={classcat(['text-12 uppercase text-blu-400', 'md:text-14'])}>
                  PROMO CODE
                </p>
                <p className={classcat(['text-12 uppercase text-gre-300', 'md:text-14'])}>
                  - 10 AED
                </p>
              </div> */}
            </div>
            {/* TODO show when have promotion feature*/}
            {/* <div className={classcat(['flex justify-between bg-gre-100 py-1 pi-2'])}>
              <p className={classcat(['text-12 text-blu-300'])}>Code123</p>
              <div className={classcat(['flex space-x-1'])}>
                <p className={classcat(['text-12 text-blu-500'])}>Applied</p>
                <CheckIcon className={classcat(['h-4.5 w-4.5 text-gre-300'])} />
              </div>
            </div> */}
          </div>
